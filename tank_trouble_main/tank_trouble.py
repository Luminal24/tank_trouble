...
class Tank:
    def __init__(self, color):
        ...
        self.tank_shape_2.color = (
            int(color[0] * 200 / 255), int(color[1] * 200 / 255), int(color[2] * 200 / 255), color[3])
        ...
        self.tank_shape_3.color = (
            int(color[0] * 123 / 255), int(color[1] * 123 / 255), int(color[2] * 123 / 255), color[3])
